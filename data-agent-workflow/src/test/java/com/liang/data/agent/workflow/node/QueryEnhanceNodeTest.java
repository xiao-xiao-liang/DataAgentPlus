...
class QueryEnhanceNodeTest {
    ...
    void shouldRetryOnceWhenQueryEnhanceResponseIsEmpty() throws Exception {
        ...
        when(llmService.callUser(eq(ModelGatewayConstant.QUERY_ENHANCE), anyString()))
                .thenReturn(
        ...
        verify(llmService, times(2)).callUser(eq(ModelGatewayConstant.QUERY_ENHANCE), anyString());

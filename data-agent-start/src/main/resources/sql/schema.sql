...
CREATE TABLE IF NOT EXISTS agent_datasource_tables (
    ...
    FOREIGN KEY (agent_datasource_id) REFERENCES agent_datasource(id) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS agent_knowledge (
    ...
    INDEX idx_embedding_status (embedding_status)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = '智能体知识源管理表 (支持文档、QA、FAQ)';
...
CREATE TABLE IF NOT EXISTS semantic_model (
    ...
    INDEX idx_status (status),
    FOREIGN KEY (agent_id) REFERENCES agent(id) ON DELETE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = '语义模型表';
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COMMENT = '用户 Prompt 配置表';

...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT = '智能体数据源表字段配置';
...
(
    ...
    invocation_id VARCHAR(64)   NOT NULL COMMENT '模型网关调用ID',
    ...
    scene_code    VARCHAR(64)   DEFAULT NULL COMMENT '调用场景编码',
    call_mode     VARCHAR(32)   DEFAULT NULL COMMENT '调用模式',
...
(
    ...
    attempt_id    VARCHAR(64)   NOT NULL COMMENT '模型网关尝试ID',
    invocation_id VARCHAR(64)   NOT NULL COMMENT '模型网关调用ID',
